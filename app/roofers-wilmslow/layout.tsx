...
export const metadata: Metadata = {
  title: 'Roofers Wilmslow | 5★ Rated',
  description: 'Trusted roofers in Wilmslow (SK9). Roof repairs, new roofs & flat roofing from a CORC-certified team. 127 five-star reviews, 25+ yrs, £10M insured.',
